...
void printState(int nproc, int cpu, int qtime){
        ...
        int ioDoneTime = INT_MAX; int proc= -1; int min= INT_MAX;
...
void procExecSim(struct process *(*scheduler)()) {
        ...
        idleProc.id = -1; idleProc.targetServiceTime = INT_MAX;
        readyQueue.id = -1; blockedQueue.id = -1;
...
struct process* SJFschedule() {
        ...
        int min_time = currentQueue->targetServiceTime; int Q_ServiceTime; int ppid=currentQueue->id;
        // 최소 시간 프로세스 찾기
...
struct process* SRTNschedule() {
        ...
        struct process *prevQueue = readyQueue.next;
        struct process *currentQueue = readyQueue.next;
        int min_time = currentQueue->targetServiceTime-currentQueue->serviceTime; int diffTime; int ppid=currentQueue->id;
        // 최소 시간 프로세스 찾기
...
struct process* GSschedule() {
        ...
        struct process *prevQueue = readyQueue.next;
        struct process *currentQueue = readyQueue.next;
        double min_time = (double)(currentQueue->serviceTime)/(double)(currentQueue->targetServiceTime); double ratioTime; int ppid=currentQueue->id;
        // 최소 시간 프로세스 찾기
...
struct process* SFSschedule() {
        ...
        struct process *prevQueue = readyQueue.next;
        struct process *currentQueue = readyQueue.next;
        int max_priority = currentQueue->priority; int currentPriority; int ppid=currentQueue->id;
        // 최대 우선순위 프로세스 찾기
